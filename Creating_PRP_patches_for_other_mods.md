...
## Batch File Creation
Gotcha before we do the precombine step, I recommend creating batch files (either .bat or .ps1) for doing these steps. If you wish you could skip this step, but I swear batch files will make your life easier especially 
