...
- New\ \[-1, -4, CW\] Raise landscape ground near the bottom pole that 16B882 has been built at (that one skybridge structure) so it doesn't seem like it's being held up by antigravity on it's support structure.
- New\ \[DLC03VimPopFactory01\] Reposition 03030B8A so it doesn't stick into the neighboring wall, which was partially covered up with some blood and debris.
- New\ \[RelayTowerInt12\] Update room bound for RelayTowerInt12 to match the autogenerated settings from Emiral's recent Interior navmesh fix mod.
