...
- \[Upend\] (Vault75): Explicitly mark 07038FB1 UDR, as the Z adjustment to the underlying ref fixed it proper. Also apply the XRLT 1E819A to ALL the UF4OP added ref in this interior.
...
- \[Upend\] (Vault75): Rip 1AAFCB out of the wall and out of the way nearby on top of a pile of trash.
- \[Upend\] (Vault75): Add Painting_CanvasSwapToPainting24 texswap to 1A5DEB
- \[PRP\] (Financial28): Move 1FE506, 1FE508, 1F34F5, 1FE4F6 to fix z-fighting
- \[Upendmaybe\] (Financial28): Remove a ClutterGenSlimeA that we presume was originally supposed to be attached to a desk. 2259F1
